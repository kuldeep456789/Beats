  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
        <div className="inline-block px-4 py-1.5 mb-6 rounded-full border border-[#00ff88]/30 bg-[#00ff88]/10 text-[#00ff88] text-sm font-semibold tracking-wide uppercase backdrop-blur-sm animate-fade-in-up">
          Youth Event Collective
        </div>
